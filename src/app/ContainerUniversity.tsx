...
import AdmitCardUniversity from './container/admitcard/AdmitCardUniversity.page';
import ProfileUniversity from './container/profile/ProfileUniversity.page';
import SubjectChoiceUniversity from './container/subject/SubjectChoiceUniversity.page';
import PaidUnpaiReportUniversity from './container/report/PaidUnpaiReportUniversity.page';
import PasswordUniversity from './container/password/PasswordUniversity';
import PasswordChangeUniversity from './container/information/PasswordChangeUniversity.page';
...
export default function ContainerUniversity() {
	...
	// console.log('user.instituteLogo', user.instituteLogo);
			...
			>
				<div className="logo">
					{!collapsed &&
						<>
							<Avatar
								src={'data:image/png;base64,' + user?.instituteLogo}
								size={118}
								className="pointer"
							/>
							<br />
			...
			<Layout className="site-layout">
				...
				<Content style={{ margin: '0 16px' }}>
					<Switch>
						...
						<Route exact path="/admit-card" component={AdmitCardUniversity} />
						<Route exact path="/profile" component={ProfileUniversity} />
						<Route exact path="/subject-choice" component={SubjectChoiceUniversity} />
						<Route exact path="/report-paid-unpaid" component={PaidUnpaiReportUniversity} />
						<Route exact path="/unipassword" component={PasswordUniversity} />
						<Route exact path="/password-change" component={PasswordChangeUniversity} />
